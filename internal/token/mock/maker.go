...
// Source: playground/internal/token (interfaces: Maker)

// Package mock_token is a generated GoMock package.
package mock_token

import (
	token "playground/internal/token"
	reflect "reflect"
	time "time"
...
func (m *MockMaker) CreateToken(arg0 int64, arg1 time.Duration) (string, *token.Payload, error) {
	m.ctrl.T.Helper()
