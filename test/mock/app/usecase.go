...
// Source: ./internal/app/usecase.go
...
func (m *MockUsecase) CreateAccount(ctx context.Context, args *app.CreateAccountParams) (*app.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) CreateTransfer(ctx context.Context, args *app.CreateTransferParams) (*app.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) CreateUser(ctx context.Context, args *app.CreateUserParams) (*app.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) GetAccount(ctx context.Context, args *app.GetAccountsParams) (*app.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) ListAccounts(ctx context.Context, args *app.ListAccountsParams) ([]app.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) LoginUser(ctx context.Context, args *app.LoginUserParams) (*app.LoginUserOutputParams, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) RenewAccessToken(ctx context.Context, refreshToken string) (*app.RenewAccessTokenOutputParams, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) SendVerifyEmail(ctx context.Context, args *app.SendVerifyEmailPayload) (*app.VerifyEmail, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) UpdateUser(ctx context.Context, args *app.UpdateUserParams) (*app.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) VerifyEmail(ctx context.Context, args *app.VerifyEmailParams) (*app.User, error) {
	m.ctrl.T.Helper()
