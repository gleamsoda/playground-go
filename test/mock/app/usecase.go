...
// Source: playground/app (interfaces: EntryUsecase,TransferUsecase,UserUsecase,WalletUsecase)
...
func (m *MockEntryUsecase) List(arg0 context.Context, arg1 app.ListEntriesInputParams) ([]app.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockTransferUsecase) Create(arg0 context.Context, arg1 app.CreateTransferInputParams) (*app.Transfer, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockUserUsecase) Create(arg0 context.Context, arg1 app.CreateUserInputParams) (*app.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
...
func (m *MockUserUsecase) GetByUsername(arg0 context.Context, arg1 string) (*app.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserUsecase) Login(arg0 context.Context, arg1 app.LoginUserInputParams) (*app.LoginUserOutputParams, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockWalletUsecase) Create(arg0 context.Context, arg1 app.CreateWalletInputParams) (*app.Wallet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
...
func (m *MockWalletUsecase) Delete(arg0 context.Context, arg1 app.GetOrDeleteWalletInputParams) error {
	m.ctrl.T.Helper()
...
func (m *MockWalletUsecase) Get(arg0 context.Context, arg1 app.GetOrDeleteWalletInputParams) (*app.Wallet, error) {
	m.ctrl.T.Helper()
...
// List mocks base method.
func (m *MockWalletUsecase) List(arg0 context.Context, arg1 app.ListWalletsInputParams) ([]app.Wallet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", arg0, arg1)
	ret0, _ := ret[0].([]app.Wallet)
	ret1, _ := ret[1].(error)
