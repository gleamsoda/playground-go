...
// Source: ./internal/pkg/token/manager.go
...
func (m *MockManager) Create(username string, duration time.Duration) (string, *token.Payload, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", username, duration)
	ret0, _ := ret[0].(string)
...
func (mr *MockManagerMockRecorder) Create(username, duration interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockManager)(nil).Create), username, duration)
}
