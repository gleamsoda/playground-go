...
// Source: ./internal/wallet/repository.go
...
func (m *MockRepository) CreateAccount(ctx context.Context, args *wallet.Account) (*wallet.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) CreateSession(ctx context.Context, args *wallet.Session) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) CreateTransfer(ctx context.Context, args *wallet.Transfer) (*wallet.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) CreateUser(ctx context.Context, args *wallet.User) (*wallet.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) CreateVerifyEmail(ctx context.Context, args *wallet.VerifyEmail) (*wallet.VerifyEmail, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetAccount(ctx context.Context, id int64) (*wallet.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetSession(ctx context.Context, id uuid.UUID) (*wallet.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSession", ctx, id)
	ret0, _ := ret[0].(*wallet.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) GetUser(ctx context.Context, username string) (*wallet.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) ListAccounts(ctx context.Context, args *wallet.ListAccountsParams) ([]wallet.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) ListTransfers(ctx context.Context, args *wallet.ListTransfersParams) ([]wallet.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) UpdateUser(ctx context.Context, args *wallet.User) (*wallet.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) UpdateUserEmailVerified(ctx context.Context, args *wallet.VerifyEmailParams) (*wallet.User, *wallet.VerifyEmail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserEmailVerified", ctx, args)
	ret0, _ := ret[0].(*wallet.User)
	ret1, _ := ret[1].(*wallet.VerifyEmail)
	ret2, _ := ret[2].(error)
...
func (m *MockRepository) UpdateVerifyEmail(ctx context.Context, args *wallet.VerifyEmail) (*wallet.VerifyEmail, error) {
	m.ctrl.T.Helper()
